...
type FakeProjectInterface struct {
	FindUserByEmailStub        func(email string) (go_tracker.ProjectMembership, error)
	...
	FindCurrentStoryStub        func(member go_tracker.ProjectMembership) (go_tracker.Story, error)
	findCurrentStoryMutex       sync.RWMutex
	findCurrentStoryArgsForCall []struct {
		member go_tracker.ProjectMembership
	}
...
func (fake *FakeProjectInterface) FindUserByEmail(email string) (go_tracker.ProjectMembership, error) {
...
func (fake *FakeProjectInterface) FindUserByEmailReturns(result1 go_tracker.ProjectMembership, result2 error) {
...
func (fake *FakeProjectInterface) FindCurrentStory(member go_tracker.ProjectMembership) (go_tracker.Story, error) {
...
func (fake *FakeProjectInterface) FindCurrentStoryArgsForCall(i int) go_tracker.ProjectMembership {
	fake.findCurrentStoryMutex.RLock()
	defer fake.findCurrentStoryMutex.RUnlock()
	return fake.findCurrentStoryArgsForCall[i].member
}

func (fake *FakeProjectInterface) FindCurrentStoryReturns(result1 go_tracker.Story, result2 error) {
